...
User.create(name:"RollyRo Ag", email:"roly@r.co")
User.create(name:"Mom", email:"nilu@amco.co")
User.create(name:"Dad", email:"sooagi@g.co")
User.create(name:"Amo Fred", email:"farh@ag.co", household_id: 2)
User.create(name:"Tara Ag", email:"taga@ag.co", household_id: 2)
User.create(name:"Khaleh Simi", email:"simi@ag.co", household_id: 2)
User.create(name:"Anna Khahar", email:"a.a@gma.como", household_id: 3)
User.create(name:"Roroo", email:"roroo@gma.co", household_id: 3)
